...
import { 
  Calendar, Search, X, Plus, Clock, ChevronDown, ChevronUp, ExternalLink, Filter, 
  IndianRupee, Users, CheckCircle, XCircle, FileText, ListChecks, UserCircle, 
  Upload, Briefcase, MapPin, Globe, Mail, Phone, AlertCircle, Save, Building,
  ...
  return (
    <div className="min-h-screen pt-16 bg-black">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        {showRequestModal && (
          <div className="fixed inset-0 bg-black/100 backdrop-blur-md flex items-center justify-center z-50 px-4" onClick={(e) => {
                  ...
                  <form onSubmit={handleSubmitRequest}>
                    <div className="mb-4">
                      <p className="text-gray-300 mb-2">
                        Requesting sponsorship from: <span className="text-white font-medium">{selectedBrandName}</span>
                      </p>
                    </div>
                    {requestError && (
                    ...
                    <div>
                      ...
                      <div className="space-y-2">
                        <input
                          ...
                          onChange={(e) => setFilters(prev => ({ ...prev, amount: [prev.amount[0], parseInt(e.target.value)] }))}
        ...
        {activeTab === 'status' && (
          <div className="bg-white/5 backdrop-blur-lg rounded-lg p-8 border border-neon-green/20">
            ...
            {requestHistoryLoading ? (
              ...
              <div className="text-center py-12">
              <p className="text-gray-400 text-lg">You haven't submitted any sponsorship requests yet.</p>
              <button
      ...
      {showModal && selectedSponsorship && (
        <div className="fixed inset-0 bg-black/80 backdrop-blur-md flex items-center justify-center z-50 px-4" onClick={(e) => {
          // Close modal when clicking outside content area
