...
const SubmitSponsorship = () => {
  ...
  const [activeSlide, setActiveSlide] = useState<'profile' | 'sponsorship' | 'packages'>('profile');
    ...
    <div className="flex items-center justify-center mb-8">
      <div className="flex items-center">
        <div className={`rounded-full w-8 h-8 flex items-center justify-center ${
          activeSlide === 'profile' ? 'bg-neon-green text-black' : 'bg-white/20 text-white'
        }`}>
          1
        </div>
        <div className={`h-1 w-16 ${profileComplete ? 'bg-neon-green' : 'bg-white/20'}`}></div>
        <div className={`rounded-full w-8 h-8 flex items-center justify-center ${
          activeSlide === 'sponsorship' ? 'bg-neon-green text-black' : 'bg-white/20 text-white'
        }`}>
          2
        </div>
      </div>
    ...
    <div className="min-h-screen pt-16 bg-black">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 pt-8 pb-20 relative z-10">
        ...
        <div className="bg-black/40 backdrop-blur-lg border border-neon-green/20 rounded-xl p-6 md:p-8 shadow-xl overflow-hidden">
          <div className="mb-6 border-b border-neon-green/20 pb-4">
