...
setApprovedSponsorships(approvedSponshorships);
      ...
      const { data: logsData } = await supabase
        .from('sponsorship_activity_logs')
        .select(`
          *,
          sponsorship_requests (
            title
        ...
        <div className="bg-white/5 backdrop-blur-lg rounded-xl p-6 border border-neon-green/20">
          ...
          <div className="space-y-4">
            {activityLogs.map((log: any) => (
              <div
                key={log.id}
                className="flex items-start gap-4 p-4 bg-white/5 rounded-lg border border-neon-green/10"
              >
                ...
                <div className="flex-1">
                  <p className="text-white">
                    ...
                    - {log.sponsorship_requests?.title}
                  </p>
        ...
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50 p-4">
          <div className="bg-black/95 rounded-xl border border-neon-green/20 p-6 max-w-6xl w-full max-h-[90vh] overflow-y-auto">
            <div className="flex justify-between items-center mb-6">
              <h2 className="text-2xl font-bold text-white">Pending Sponsorship Requests</h2>
              <button
